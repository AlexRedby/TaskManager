    ...
    <form name="addForm" action="SaveTask">
        <fieldset class="fildsetAdd">
            ...
            <input type="text" id="name" name="name"
                   value="${oldTask.getName()}" size="20" class="fields" required/><br>


            <label for="info">Описание:</label>
            <textarea id="info" name="info" class="fields"
                      style="resize: none" required>${oldTask.getInfo()}</textarea>


            <label for="dateTime">Дата и время:</label>
            <input class="inline fields" name="date" type="datetime-local" id="dateTime"><br>
            <script>
                ...
                function getFormattedDate(date) {
                    ...
                    var formattedDate = year + "-" + month + "-" + day + "T" + hour + ":" + min;
            ...
            <input type="text" id="contacts" name="contacts"
                   value="${oldTask.getContacts()}" size="20" class="fields" required/><br>


            <label>Активность:</label>

            <input type="radio" id="active" name="active" value="active" checked/>
            <label for="active">активная</label>

            <input type="radio" id="notActive" name="active" value="not_active"/>
            <label for="notActive">не активная</label>
